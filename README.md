...
1. If you were to describe semantic HTML to the next cohort of students, what would you say? It is a way to make give meaning to HTML. Using conventional naming practices for elements to make it easy for the computer and other devs to understand. 
...
you can checkout branches and all work at the same time adn then eventually merge code to the master and hope it all works together. it also allows you to see who changed what code and when. If something breaks you can restore to an old version if needed. 

5. Define mobile-first design in your own words.
using a min-width- instead of max- starting to develop mobile first and then move to desktop and other sizes bc mobile is the most popular 
